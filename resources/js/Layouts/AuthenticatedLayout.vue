...
<template>
  <div :key="$page.url" class="min-h-screen mx-auto text-base">
    ...
    <nav class="absolute top-0 left-0 z-30 w-full">
      <Container>
        <div class="flex items-center justify-between py-4 md:justify-start md:space-x-10 text-md">
          <aside class="hidden sm:block items-center justify-start md:flex md:flex-1 lg:w-0 divide-x divide-neutral-200/5">
    ...
    <div class="relative bg-primary-600 py-32 z-0 overflow-hidden">
      <slot name="cover" />
      <Container class="relative z-10 flex items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="pl-4">
            <h1 class="block text-3xl font-bold text-white break-words">
              Welcome to King's Gaming
            </h1>

            <p class="block text-neutral-50 text-lg break-words">
    ...
    <!-- Page Content -->
    <main class="relative -mt-16 z-10">
      <Container>
        <Card class="bg-neutral-800 shadow">
          <div class="p-4">
            <slot />
          </div>
        </Card>
